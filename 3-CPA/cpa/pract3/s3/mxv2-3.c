...
int main(int argc, char *argv[])
{
  ...
  */
  MPI_Scatter(&M[proc*sz], sz, MPI_DOUBLE,Mloc, sz, MPI_DOUBLE,0,MPI_COMM_WORLD);
  MPI_Scatter(&x[proc*nb], nb, MPI_DOUBLE,xloc1, nb, MPI_DOUBLE,0,MPI_COMM_WORLD);
...
#define ABS(a) ((a) >= 0 ? (a) : -(a))
  ...
  if (me == 0) {
    ...
    printf("Time using %d processes: %.10f\n", num_procs, t);
  }
