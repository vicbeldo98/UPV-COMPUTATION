...
/* Generador del vector de t�rminos independientes    */
/* de forma que la soluci�n del sistema de ecuaciones */
/* sea [1,1,...,1]'                                   */
double *genVec(int n)
{
  int i, j;
...
int main(int argc, char *argv[])
{
 ...
 /* MPI_Scatter(A[0], mb * n, MPI_DOUBLE,
  ...
  int i=0;
  for(i=0;i<mb;i++){
    MPI_Scatter(&A[p*i][0],n,MPI_DOUBLE,&Aloc[i][0],n,MPI_DOUBLE,0,MPI_COMM_WORLD);
  }
